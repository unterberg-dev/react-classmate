import{X as l,j as e,C as t,L as r,b as d,H as u,B as n,i as c,o as p,a as h}from"../chunks/chunk-BnKQMNIn.js";import{i as m}from"../chunks/chunk-C9p0Z5iI.js";import{D as g,H as s}from"../chunks/chunk-Bwzqnnt1.js";import{S as a,a as i,c as o}from"../chunks/chunk-h-dyDwU6.js";import{D as f}from"../chunks/chunk-BM5hSwQE.js";/* empty css                      */import"../chunks/chunk-CYDrz2XN.js";/* empty css                      *//* empty css                      *//* empty css                      */const x=`import { LoaderCircle } from "lucide-react"
...
export default Button`,b=`<Button type="button" size="lg" >Button Big</Button>
<Button type="button">Button Medium</Button> // falls back to default size (md)
<Button type="button" size="sm" >Button Small</Button>
<Button type="button" size="xs">Button Extra Small</Button>`,y=l.div`
  flex
  flex-wrap
  items-center
  gap-4
  w-full
`,w=()=>e.jsxs(e.Fragment,{children:[e.jsx(g,{main:"Advanced Tailwind Button",pre:"Working with variants",excerpt:e.jsxs(e.Fragment,{children:["An example of a advanced Tailwind / Uno (Windi) button component, which fully utilizes the features of",e.jsx(t,{children:"variants"})," and tailwind classes."]})}),e.jsx(a,{children:"Developers Note"}),e.jsxs(i,{children:[e.jsxs("p",{children:[`It all started here: The task of blueprinting a redundantly placed button, fully utilizing it's design thru property-controlled utility classes. Writing this only as react component is a nightmare. And even then, at this point when you think you finally have this one "perfect button", you are unable to properly maintain it through the variability of project requirements and the resulting "horizontal styling". My wish was to read those heavily styled components like a book, with all the information I need to know about it's design and behavior. This is why I created`," ",e.jsx(r,{href:d.start,children:"react-classmate"}),"."]}),e.jsx(o,{children:"The main idea of this project is to engage myself to properly design and manage classnames and separate them from the application logic."}),e.jsxs(o,{children:["This example requires you to have a basic understanding of tailwind and the utility classes. If you are not familiar with it, I would recommend you to read the"," ",e.jsx(r,{href:"https://tailwindcss.com/docs/utility-first",children:'tailwind "Utility-First Fundamentals"'})," ","first"]})]}),e.jsx(a,{children:"Button Component"}),e.jsxs(i,{children:[e.jsxs("p",{children:["The below code features dark (:dark) mode, hover (:hover) and active (:active) state as utility classes. You can also control ",e.jsx(t,{children:"noGutter"}),", ",e.jsx(t,{children:"disabled"}),", ",e.jsx(t,{children:"loading"}),", ",e.jsx(t,{children:"noShadow"})," and"," ",e.jsx(t,{children:"type"})," properties."]}),e.jsxs(o,{children:["It will introduce the usage of the utility type ",e.jsx(t,{children:"VariantsConfig"})," and the utility function ",e.jsx(t,{children:"convertRcProps"}),". More on that both below"]}),e.jsx(s,{input:x}),e.jsxs(f,{children:[e.jsxs(u,{children:["Usage of important ",e.jsx(t,{children:"!"})," prefix from tailwind"]}),e.jsxs(o,{children:["In general I would not recommend using ",e.jsx(t,{children:"!"}),"-override (which is similar to !important) too often in classmate components, since we should prereserve it's usage. In case of this button, we only override the padding and the shadow which can be set as explicit props."]})]})]}),e.jsx(a,{children:"Button Sizing"}),e.jsxs(i,{children:[e.jsxs("p",{children:["This is a basic button with the ",e.jsx(t,{children:'type="button"'})," attribute."]}),e.jsx("div",{children:e.jsx(s,{input:b})}),e.jsxs(y,{children:[e.jsx(n,{type:"button",size:"lg",children:"Button Big"}),e.jsx(n,{type:"button",children:"Button Medium"}),e.jsx(n,{type:"button",size:"sm",children:"Button Small"}),e.jsx(n,{type:"button",size:"xs",children:"Button Extra Small"})]})]})]}),v=Object.freeze(Object.defineProperty({__proto__:null,default:w},Symbol.toStringTag,{value:"Module"})),B=()=>"Advanced Tailwind Button | react-classmate",j=Object.freeze(Object.defineProperty({__proto__:null,default:B},Symbol.toStringTag,{value:"Module"})),E={isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},onBeforeRenderEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},dataEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},Loading:{type:"standard",definedAtData:{filePathToShowToUser:"vike-react/__internal/integration/Loading",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:c}},onRenderClient:{type:"standard",definedAtData:{filePathToShowToUser:"vike-react/__internal/integration/onRenderClient",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:p}},hydrationCanBeAborted:{type:"standard",definedAtData:{filePathToShowToUser:"vike-react/config",fileExportPathToShowToUser:["default","hydrationCanBeAborted"]},valueSerialized:{type:"js-serialized",value:!0}},lang:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/+config.ts",fileExportPathToShowToUser:["default","lang"]},valueSerialized:{type:"js-serialized",value:"en"}},Layout:{type:"cumulative",definedAtData:[{filePathToShowToUser:"/pages/docs/+Layout.tsx",fileExportPathToShowToUser:[]},{filePathToShowToUser:"/pages/+Layout.tsx",fileExportPathToShowToUser:[]}],valueSerialized:[{type:"plus-file",exportValues:m},{type:"plus-file",exportValues:h}]},Page:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/docs/examples/advanced-button/+Page.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:v}},title:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/docs/examples/advanced-button/+title.ts",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:j}}};export{E as configValuesSerialized};
